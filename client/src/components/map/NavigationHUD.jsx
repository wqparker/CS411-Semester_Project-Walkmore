export default function NavigationHUD({ directions, currentStepIndex, onEndTrip, onFitRoute, isRerouting }) {
  ...
  return (
    <div style={{
      ...
      pointerEvents: 'none',
      background: isRerouting ? '#F59E0B' : isArrived ? '#10B981' : 'var(--bg)',
      borderBottom: `1px solid ${isRerouting ? '#F59E0B' : isArrived ? '#10B981' : 'var(--border)'}`,
      ...
      <div style={{ pointerEvents: 'all' }}>
        ...
        {/* Progress + buttons — hidden while rerouting */}
        {!isRerouting && (
